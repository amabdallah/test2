...
__engine = create_engine('sqlite:///wdm.sqlite')
...
class AggregationStatistic(Base):
    ...
    AggregationStatisticCV = Column(Text(255))
...
class AttributeCategory(Base):
    ...
    AttributeCategoryName = Column(Text(255), nullable=False)
    CategoryDefinition = Column(Text)	
...
class AttributeTypes(Base):
    ...
    AttributeTypeCV = Column(Text(255), unique=True)
    Definition = Column(Text)
...
class InstanceNames(Base):
    ...
    InstanceNameCV = Column(Text(255))
    Definition = Column(Text)
...
class MethodType(Base):
    ...
    MethodTypeCV = Column(Text(255), unique=True)
    Definition = Column(Text)
...
class Organizations(Base):
    ...
    OrganizationWebpage = Column(Text(255))
    Description = Column(Text)
...
class Sources(Base):
    ...
    SourceWebpage = Column(Text(500))
    SourceCitation = Column(Text(500))
    Description = Column(Text)
...
class SpatialReference(Base):
    ...
    SRSCode = Column(Integer)
    SRSNameCV = Column(Text(500), nullable=False)
    SRSWebpage = Column(Integer)
    SRSDescription = Column(Text)
...
class TimeSeries(Base):
    ...
    WaterOrCalendarYear = Column(Text(50), nullable=False)
...
class VerticalDatum(Base):
    ...
    VerticalDatumCV = Column(Text(255))
    Definition = Column(Text)
