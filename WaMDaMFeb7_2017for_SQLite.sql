...
CREATE TABLE Attributes (
	...
	ON UPDATE NO ACTION ON DELETE NO ACTION,
	FOREIGN KEY (UnitNameCV) REFERENCES CV_CV_Units (UnitNameCV)
	ON UPDATE NO ACTION ON DELETE NO ACTION,
...
CREATE TABLE TimeSeries (
	...
	ON UPDATE NO ACTION ON DELETE NO ACTION,
	FOREIGN KEY (IntervalTimeUnitCV) REFERENCES CV_CV_Units (UnitNameCV)
	ON UPDATE NO ACTION ON DELETE NO ACTION,
	FOREIGN KEY (DataValuesMapperID) REFERENCES DataValuesMapper (DataValuesMapperID)
	ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE Scenarios (
	...
	Description TEXT   NULL,
	FOREIGN KEY (TimeStepUnitCV) REFERENCES CV_CV_Units (UnitNameCV)
	ON UPDATE NO ACTION ON DELETE NO ACTION,
