...
-- Generated by Adel Abdallah December 14,2016 based on WaM-DaM XML design named WaMDaMDec14_2016.xml generated by DbWrench V4.0 @ http://www.dbwrench.com
...
CREATE TABLE AttributesCV (
	...
	FOREIGN KEY (AttributeCategoryCVID) REFERENCES AttributeCategoryCV (AttributeCategoryID)
...
CREATE TABLE VerticalDatum (
	VerticalDatumID INTEGER  AUTO_INCREMENT NOT NULL PRIMARY KEY,
...
CREATE TABLE SeasonalParameters (
	...
	FOREIGN KEY (DataValuesMapperID) REFERENCES DataValuesMapper (DataValuesMapperID)
	ON UPDATE NO ACTION ON DELETE NO ACTION,
	FOREIGN KEY (SeasonNameCVID) REFERENCES SeasonName (SeasonNameID)
	ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE Methods (
	...
	Description TEXT   NULL,
	FOREIGN KEY (MethodTypeCVID) REFERENCES MethodType (MethodTypeID)
	ON UPDATE NO ACTION ON DELETE NO ACTION,
...
CREATE TABLE MasterNetworks (
	...
	ON UPDATE NO ACTION ON DELETE NO ACTION,
	FOREIGN KEY (VerticalDatumCVID) REFERENCES VerticalDatum (VerticalDatumID)
	ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE Scenarios (
	...
	ON UPDATE NO ACTION ON DELETE NO ACTION,
	FOREIGN KEY (TimeStepUnitCVID) REFERENCES Units (UnitID)
	ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE Attributes (
	...
	ON UPDATE NO ACTION ON DELETE NO ACTION,
	FOREIGN KEY (UnitCVID) REFERENCES Units (UnitID)
	ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE ObjectAttributes (
	...
	ON UPDATE NO ACTION ON DELETE NO ACTION,
	FOREIGN KEY (AttributeTypeCVID) REFERENCES AttributeType (AttributeTypeCVID)
	ON UPDATE NO ACTION ON DELETE NO ACTION,
