...
-- Generated by Adel Abdallah January 4, 2017 based on WaM-DaM XML design named WaMDaMJan4_2017.xml generated by DbWrench V4.0 @ http://www.dbwrench.com
...
CREATE TABLE BinaryValueMeaning (
	BinaryValueMeaningCVID INTEGER  AUTO_INCREMENT NOT NULL PRIMARY KEY,
	AttributeCodeBinary VARCHAR (255)  NOT NULL,
...
CREATE TABLE SpatialReference (
	SpatialReferenceCVID INTEGER  AUTO_INCREMENT NOT NULL PRIMARY KEY,
	SRSCode INTEGER   NULL,
...
CREATE TABLE Binarys (
	...
	FOREIGN KEY (BinaryValueMeaningCVID) REFERENCES BinaryValueMeaning (BinaryValueMeaningCVID)
	ON UPDATE NO ACTION ON DELETE NO ACTION,
...
CREATE TABLE TimeSeriesValues (
	...
	CorrespondingValue FLOAT   NOT NULL,
...
CREATE TABLE Instances (
	...
	FOREIGN KEY (InstanceNameCVID) REFERENCES InstanceNames (InstanceNameCVID)
	ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE MasterNetworks (
	...
	Description TEXT   NULL,
	FOREIGN KEY (SpatialReferenceCVID) REFERENCES SpatialReference (SpatialReferenceCVID)
	ON UPDATE NO ACTION ON DELETE NO ACTION,
