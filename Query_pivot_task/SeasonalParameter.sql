...
SELECT ObjectType,InstanceName,AttributeName, UnitNameCV, InstanceName,MasterNetworkName,ScenarioName, AttributeDataTypeCV,SeasonName,SeasonValue,Mapping.MappingID
FROM Attributes 
...
WHERE AttributeDataTypeCV='SeasonalParameter' AND InstanceName='Node 2.02' AND AttributeName='Net Evaporation - inches'  AND ScenarioName='Bear Dry Year Model'
-- AND InstanceName='Hyrum Reservoir'
